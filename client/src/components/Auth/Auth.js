    ...
    <div className='main'>
      ...
      <div className='authMain'>
        <div className='authForm login'>
          ...
          <hr />
          <div id='authGoogle'>
            <i class='fab fa-google' style={{ marginRight: '15px' }}></i>Log in
            with Google
          </div>
          <div className='authSubtext'>Forgot password?</div>
          <hr />
          <div className='authSubtext'>
            Don't have an account? <span className='authSwitch'>Sign Up</span>
          </div>
        </div>
        <div className='authForm signup'>
          ...
          <hr />
          <div className='authSubtext'>
            Have an account? <span className='authSwitch'>Log In</span>
          </div>
        </div>
      </div>
      <Footer />
